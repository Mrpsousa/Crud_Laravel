    ...
    <div class="container">
        ...
        <div id="navbarSite" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}">Iníco </a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="https://github.com/Mrpsousa">Git</a>
        ...
        <div class="col-3">
            <nav id="navbarVertical" class="navbar navbar-light bg-light">
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link" href="{{ url('/sem1') }}">Primeiro Semestre </a>
                    <a class="nav-link" href="{{ url('/sem2') }}">Segundo Semestre </a>
                    <a class="nav-link" href="{{ url('/sem3') }}">Terceiro Semestre </a>
                    <a class="nav-link" href="{{ url('/sem4') }}">Quarto Semestre </a>
                    <a class="nav-link" href="{{ url('/sem5') }}">Quinto Semestre </a>
                    <a class="nav-link" href="{{ url('/sem6') }}">Sexto Semestre </a>
                    <a class="nav-link" href="{{ url('/sem7') }}">Sétimo Semestre </a>
                    <a class="nav-link" href="{{ url('/sem8') }}">Oitavo Semestre </a>
                    <a class="nav-link" href="{{ url('/opt') }}">Optativas</a>
                </nav>
            </nav>
        </div>

        <div class="col-9">
                <img class="card-img-top" src="{{ asset('img/uesc.png') }}">
        </div>
    </div>
